...
- For database-backed handlers, consult `docs/db.md` first and `docs/database-dto-spec.md` before shaping the endpoint around any table or function.
...
- Do not expose private `curriculum` or `internal_api` schema details as public HTTP contracts.
